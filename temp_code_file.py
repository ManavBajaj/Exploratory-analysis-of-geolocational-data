...
dataframe_filtered.drop([4, 17, 18], axis=0, inplace=True)
dataframe_filtered.drop(['cc', 'country', 'state', 'city'], axis=1, inplace=True)

# Map visualization
map_bang = f.Map(location=[17.5055, 78.4872], zoom_start=12)
...
for k in possible_k_values:
    ...
    kmeans.fit(df_evaluate[['lat', 'lng']])
...
# Choose the optimal k based on the elbow plot (manually)
kclusters = 3  # Adjust this based on the elbow in the plot
...
map_bang.save("map_for_kmeans.html")  
